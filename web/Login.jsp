<%-- 
    Document   : Login
    Created on : Jul 6, 2023, 9:48:26 PM
    Author     : ASP_REF
--%>
    ...
    <body>
        <div id="logreg-forms">
            <form class="form-signin" action="login" method="post" >
                ...
                <input name="user1" type="text" id="inputUser" class="form-control" placeholder="User Name" required="" autofocus="">
            ...
            <form action="signup" class="form-signup" method="post"  >
                ...
                <input name="phone" type="tel" id="user-phone" class="form-control" placeholder="Phone" required autofocus="">
