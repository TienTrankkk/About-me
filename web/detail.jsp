<%-- 
    Document   : detail
    Created on : Jul 12, 2023, 9:52:44 PM
    Author     : Admin
--%>
    ...
    <body>
        ...
        <div class="container-fluid bg-secondary mb-5">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
                <h1 class="font-weight-semi-bold text-uppercase mb-3">Shop Decor</h1>
        ...
        <div class="container-fluid py-5">
            <div class="row px-xl-5">
                ...
                <div class="col-lg-4 pb-5">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">${price} VND</h3>
                    <p class="mb-4">${type}</p>
                    <!--                <div class="d-flex mb-3">
                    ...
                    <form action="detail" method="post">
                        ...
                        <div class="d-flex align-items-center mb-4 pt-2">
                            <div class="input-group quantity mr-3" style="width: 130px;">
                                ...
                                <input type="text" class="form-control bg-secondary text-center" value="1" name="quan">
                                <div class="input-group-btn">
